...
class GrafoDeColaboracoes:
    ...
    def __init__(self, grupo, diretorioDeSaida):
        ...
        self.grafoDeCoAutoriaNormalizado.draw(path=diretorioDeSaida + '/grafoDeColaboracoesNormalizado.png',
                                              format='png')
        self.grafoDeCoAutoriaNormalizado.draw(path=diretorioDeSaida + '/grafoDeColaboracoesNormalizado.dot',
                                              format='dot')
