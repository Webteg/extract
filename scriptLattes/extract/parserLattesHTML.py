...
from data.orientacoes.orientacaoConcluida import OrientacaoConcluida
from data.orientacoes.orientacaoEmAndamento import OrientacaoEmAndamento
from data.producoesArtisticas.producaoArtistica import ProducaoArtistica
from data.producoesBibliograficas.apresentacaoDeTrabalho import ApresentacaoDeTrabalho
from data.producoesBibliograficas.artigoAceito import ArtigoAceito
...
from data.producoesBibliograficas.outroTipoDeProducaoBibliografica import OutroTipoDeProducaoBibliografica
from data.producoesBibliograficas.resumoEmCongresso import ResumoEmCongresso
...
from data.producoesTecnicas.outroTipoDeProducaoTecnica import OutroTipoDeProducaoTecnica
from data.producoesTecnicas.processoOuTecnica import ProcessoOuTecnica
from data.producoesTecnicas.produtoTecnologico import ProdutoTecnologico
from data.producoesTecnicas.softwareComPatente import SoftwareComPatente
from data.producoesTecnicas.softwareSemPatente import SoftwareSemPatente
from data.producoesTecnicas.trabalhoTecnico import TrabalhoTecnico
from data.producoesUnitarias.areaDeAtuacao import AreaDeAtuacao
from data.producoesUnitarias.formacaoAcademica import FormacaoAcademica
