...
from scriptLattes.data.orientacoes.orientacaoConcluida import OrientacaoConcluida
from scriptLattes.data.orientacoes.orientacaoEmAndamento import OrientacaoEmAndamento
from scriptLattes.data.producoesArtisticas.producaoArtistica import ProducaoArtistica
from scriptLattes.data.producoesBibliograficas.apresentacaoDeTrabalho import ApresentacaoDeTrabalho
from scriptLattes.data.producoesBibliograficas.artigoAceito import ArtigoAceito
...
from scriptLattes.data.producoesTecnicas.outroTipoDeProducaoTecnica import OutroTipoDeProducaoTecnica
from scriptLattes.data.producoesTecnicas.processoOuTecnica import ProcessoOuTecnica
from scriptLattes.data.producoesTecnicas.produtoTecnologico import ProdutoTecnologico
from scriptLattes.data.producoesTecnicas.softwareComPatente import SoftwareComPatente
from scriptLattes.data.producoesTecnicas.softwareSemPatente import SoftwareSemPatente
from scriptLattes.data.producoesTecnicas.trabalhoTecnico import TrabalhoTecnico
from scriptLattes.data.producoesUnitarias.areaDeAtuacao import AreaDeAtuacao
from scriptLattes.data.producoesUnitarias.formacaoAcademica import FormacaoAcademica
from scriptLattes.data.producoesUnitarias.idioma import Idioma
from scriptLattes.data.producoesUnitarias.premioOuTitulo import PremioOuTitulo
from scriptLattes.data.producoesUnitarias.projetoDePesquisa import ProjetoDePesquisa
# from scriptLattes.data.eventos.organizacaoDeEvento import OrganizacaoDeEvento
# from scriptLattes.data.eventos.participacaoEmEvento import ParticipacaoEmEvento
                    ...
                    if self.achouProjetoDePesquisa:
                        if not self.salvarParte3:
                            ...
                            if len(self.partesDoItem) >= 3:
                                iessimoProjetoDePesquisa = ProjetoDePesquisa(self.idMembro,
                                                                             self.partesDoItem)  # criamos um objeto com a lista correspondentes às celulas da linha
